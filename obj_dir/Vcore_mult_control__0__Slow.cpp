...
VL_ATTR_COLD void Vcore_mult_control___stl_sequent__TOP__core__mult_fu__multiply_cu__0(Vcore_mult_control* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vcore_mult_control___stl_sequent__TOP__core__mult_fu__multiply_cu__0\n"); );
...
VL_ATTR_COLD void Vcore_mult_control___stl_sequent__TOP__core__mult_fu__multiply_cu__1(Vcore_mult_control* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vcore_mult_control___stl_sequent__TOP__core__mult_fu__multiply_cu__1\n"); );
    Vcore__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vcore_mult_control___ctor_var_reset(Vcore_mult_control* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vcore_mult_control___ctor_var_reset\n"); );
    Vcore__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
