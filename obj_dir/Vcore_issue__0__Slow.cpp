...
VL_ATTR_COLD void Vcore_issue___stl_sequent__TOP__core__res_sched__0(Vcore_issue* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vcore_issue___stl_sequent__TOP__core__res_sched__0\n"); );
...
VL_ATTR_COLD void Vcore_issue___stl_sequent__TOP__core__res_sched__1(Vcore_issue* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vcore_issue___stl_sequent__TOP__core__res_sched__1\n"); );
    Vcore__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
...
VL_ATTR_COLD void Vcore_issue___stl_comb__TOP__core__res_sched__0(Vcore_issue* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vcore_issue___stl_comb__TOP__core__res_sched__0\n"); );
    Vcore__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
    VlWide<3>/*95:0*/ __Vtemp_1;
...
VL_ATTR_COLD void Vcore_issue___ctor_var_reset(Vcore_issue* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vcore_issue___ctor_var_reset\n"); );
    Vcore__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    VL_SCOPED_RAND_RESET_W(163, vlSelf->new_packet, __VscopeHash, 11351041001544598121ull);
    ...
    vlSelf->curr_branch_pc = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 283737466986729798ull);
    vlSelf->prediction = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 8174343725260504883ull);
    vlSelf->ins = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 10665424782372718567ull);
    ...
    vlSelf->V_k = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 5296668101010614932ull);
    vlSelf->V_j = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 6306660384336592347ull);
    vlSelf->Q_temp_j = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 16897038283747828293ull);
    vlSelf->Q_temp_k = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 14090119996254649899ull);
    ...
    vlSelf->temp_load = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 18097969734407716749ull);
    vlSelf->issue_writes_temp = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 8887796889371484622ull);
    ...
    vlSelf->csr_valid_write_temp = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 5853678271755752467ull);
    vlSelf->csr_valid_read_temp = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 10892662058241480638ull);
